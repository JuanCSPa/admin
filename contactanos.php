    	...
    	<article class="container-fluid">
    		<div class="row">
    			<div class="col-sm-5 col-sm-offset-1">
    				<h2>Dirección</h2>
    				<!--<h5>Av. Nuevo Leon 254 - 304, Col. Hipódromo, C.P. 06100 <br>Ciudad de México.</h5>-->
    				<div style="border-left: 5px solid #E6E6E6;" class="pd-l-30">
    					<h3 class="grupo">Grupo Industrial Hegues</h3>
    					<p class="direccion"><i class="fa fa-map-marker"></i>Av. Nuevo León 254 - 304, <br>Col. Hipódromo, C.P. 06100 <br>Ciudad de México.</p>
    					<p><a href="mailto:gih@hegues.com.mx"><i class="fa fa-envelope"></i> gih@hegues.com.mx</a></p>
    					<div class="row">
    						<div class="col-xs-6">
    							<p><a href="tel:015555152203"><i class="fa fa-phone"></i> 01(55)5515-2203</a></p>
    							<p><a href="tel:015552717755"><i class="fa fa-phone"></i> 01(55)5271-7755</a></p>
    						</div>
    						<div class="col-xs-6">
    							<p><a href="tel:015552735613"><i class="fa fa-phone"></i> 01(55)5273-5613</a></p>
    							<p><a href="tel:015552730069"><i class="fa fa-phone"></i> 01(55)5273-0069</a></p>
    						</div>
    					</div>
						<h3 class="grupo">Sucursal Querétaro</h3>
						<p><a href="mailto:asaucedo@hegues.com.mx"><i class="fa fa-envelope"></i> asaucedo@hegues.com.mx</a></p>
						<p><a href="tel:01442-278-3208"><i class="fa fa-phone"></i> 01(442)-278-3208</a></p>
						<h3 class="grupo">Sucursal Coatzacoalcos</h3>
						<p><a href="mailto:flopez@hegues.com.mx"><i class="fa fa-envelope"></i> flopez@hegues.com.mx</a></p>
						<p><a href="tel:01921-212-1140"><i class="fa fa-phone"></i> 01(921)-212-1140</a></p>
    				</div>
    			</div>
    			<div class="col-sm-6" style="background: #e4c67b; padding: 0% 9% 5% 3%;">
    				...
    				<form autocomplete="off" action="#" enctype="multipart/form-data" id="contactoForm" name="contactoForm" method="post">
    					...
    					<div class="row">
    						<div class="col-sm-6">
    							<input type="tel" name="telefono" id="telefono" class="form-control" required placeholder="Teléfono...">
    						</div>
    						<div class="col-sm-6">
