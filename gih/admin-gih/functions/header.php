...
.treeview span{
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar" style=" background-size: cover; background-position: center center; display: block; position: fixed; height: 100%; background-image: url(../../img/sidebar-42.jpg);">
