...
include '../model/barsomos.class.php';
    ...
    <div class="box-body">
      <div class="form-group">
    		...
    		<div class="col-xs-6 col-md-6">
				...
				<input type="text" name="titulo1" class="form-control" placeholder="Titulo principal" value="<?=$getData[0]['bar_titulo_1']?>">
        <label >Contenido</label>
				<textarea name="content1" rows="5" class="form-control borderColor" placeholder="Contenido Misión de la Empresa"><?=$getData[0]['bar_content_1']?></textarea>
				<div id="msgBoxSubir"></div>
        </div>
				<div class="col-xs-6 col-md-6">
					<br><br><br>
					<label for="">Titulo Dos</label>
					<input type="text" name="titulo2" class="form-control" placeholder="Visión" value="<?=$getData[0]['bar_titulo_2']?>">
					<label for="">Contenido</label>
					<textarea name="content2" rows="5" class="form-control borderColor" placeholder="Contenido Visión de la Empresa"><?=$getData[0]['bar_content_2']?></textarea>
				</div>
     	...
     	<script>
			...
			function subirInformacion(){
				...
				$.ajax({
					url:'../control/barsomos.update.php',
					type:'POST',
					data: formData,
					cache: false,
					contentType: false,
