...
<body >
  <div class="container" style="width:800px; font-family:Georgia, 'Times New Roman', Times, serif; text-align:center; margin:auto;">
   ...
   <div style="width:100%; background:#fff; text-align:center; padding:10px;">    
    	<h2 style="text-align:center;padding-bottom:20px; font-weight:200; border-bottom:solid 1px #fcc92e;">¡Confirmación de tu pedido!</h2>
        
        <h3 style="padding:20px; font-weight:200;">Buen día :nombre:<br>
		Agradecemos tu compra, en breve te haremos llegar tu pedido. <br><br>
        Detalles del pedido:
        </h3>
		...
		<table align="center" cellpadding="5px" width="800" style="text-align:center;border-top:dashed 1px #fcc92e; border-bottom:dashed 1px #fcc92e;">
            ...
            <tr style="color:#797878;">
                ...
                <td>345</td>
                <td>Pizarrón 78 pulgadas<br>
				Pantalla multifuncional de alto rendimiento<br>
				CÓDIGO: Pizarrón 78 </td>
                <td>$ 1239</td>
                <td>2017-11-06 09:29:08</td>
            </tr>
