...
<body >
  <div class="container" style="width:800px; font-family:Georgia, 'Times New Roman', Times, serif; text-align:center; margin:auto;">
   ...
   <div style="width:100%; background:#fff; text-align:center; padding:10px;">    
		...
		Nuevamente agradecemos tu compra y te confirmamos que tu pago se ha realizado con éxito. En breve te enviaremos un correo para que puedas dar seguimiento a tu pedido.<br><br>
        Detalles del pago:
        </h3>
